<x-app-layout>
                            ...
                            <tbody>
                                @if (count($notas) > 0)
                                    @foreach ($notas as $key => $nota)
                                        ...
                                        @foreach ($nota->user->receipt as $receipt)
                                            @php
                                                if (
                                                    ...
                                                    $nota->created_at->format('Y:m:d H:m:s')
                                                ) {
                                        ...
                                        {{-- todo - Print Area --}}
                                        <div class="" id="printableArea{{ $key }}">
                                                            ...
                                                            <div class="steps">
                                                                <div class="step">
                                                                    ...
                                                                    <div class="payments">
                                                                        ...
                                                                        <div class="details">
                                                                            @foreach ($nota->user->receipt as $receipt)
                                                                                @if ($receipt->created_at->format('Y:m:d H:m:s') === $nota->created_at->format('Y:m:d H:m:s'))
    ...
    <script>
        $('#button-print').on('click', () => {
            const printableAreas = document.querySelectorAll('[id^="printableArea"]');
            printableAreas.forEach((area, index) => {
                printFunction(`printableArea${index}`);
            });
        });
